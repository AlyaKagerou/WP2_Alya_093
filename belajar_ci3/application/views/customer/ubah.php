								...
								<form action="<?= base_url('customer/proses_ubah/' . $customer->id) ?>" id="form-tambah" method="POST">
									...
									<div class="form-row">
										...
										<div class="form-group col-md-6">
											...
											<input type="text" name="email" placeholder="Masukkan Password" autocomplete="off"  class="form-control" required value="<?= $customer->email ?>">
										</div>
										<div class="form-group col-md-6">
											<label for="hp"><strong>No. Hp</strong></label>
											<input type="text" name="hp" placeholder="Masukkan Password" autocomplete="off"  class="form-control" required value="<?= $customer->hp ?>">
										</div>
									</div>
									<hr>
