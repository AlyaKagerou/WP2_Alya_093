				...
				<div class="clearfix">
					...
					<div class="float-right">
						<?php if ($this->session->login['role'] == 'admin'): ?>
							<a href="<?= base_url('laporan/laporan_customer_pdf') ?>" class="btn btn-danger btn-sm"><i class="fa fa-file-pdf"></i>&nbsp;&nbsp;Export</a>
										...
										<tr>
											...
											<?php if ($this->session->login['role'] == 'admin'): ?>
												...
												<td>
													...
													<a onclick="return confirm('apakah anda yakin?')" href="<?= base_url('customer/hapus/' . $customer->id) ?>" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
												</td>	
											<?php endif ?>
										</tr>
									<?php endforeach ?>
